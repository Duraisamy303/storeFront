...
// slider data 
const slider_data = [
  { subtitle: 'Fine Jewellery', title: 'LUXURY CAN BE AFFORDABLE', img: slider_img_1, content: "Looked up one of the more obscure latin words, consectetor, from a lorem ipusom passage, and going through the cites of the word" },
  { subtitle: 'Find the ideal gift', title: 'JEWELLERY WITH A MODERN TWIST', img: slider_img_2, content: "Looked up one of the more obscure latin words, consectetor, from a lorem ipusom passage, and going through the cites of the word" },
  { subtitle: 'Fine Jewellery', title: 'LUXURY CAN BE AFFORDABLE', img: slider_img_3, content: "Looked up one of the more obscure latin words, consectetor, from a lorem ipusom passage, and going through the cites of the word" },
  { subtitle: 'Fine Jewellery', title: 'LUXURY CAN BE AFFORDABLE', img: slider_img_4, content: "Looked up one of the more obscure latin words, consectetor, from a lorem ipusom passage, and going through the cites of the word" },
]

// slider nav data
const slider_nav_data = [
  { icon: nav_icon_1, title: <>Ring & Earring</> },
  { icon: nav_icon_2, title: <>Bangles & Bracelets</> },
  { icon: nav_icon_3, title: <>Drop Necklaces</> },
  { icon: nav_icon_4, title: <>Diamond Necklaces</> },
]
